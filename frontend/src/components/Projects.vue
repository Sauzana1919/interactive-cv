...
import  WebsiteTokoOnline from '../assets/WebsiteTokoOnline.jpg'
import AplikasiTanajemenTugas from '../assets/AplikasiTanajemenTugas.jpeg'

const projects = [
  {
    title: 'Website Toko Online', image: WebsiteTokoOnline,
    description: 'Platform e-commerce dengan fitur keranjang belanja.', tech: ['Vue.js', 'Express.js',
      'PostgreSQL'], link: '#'
  },
  {
    title: 'Aplikasi Manajemen Tugas', image: AplikasiTanajemenTugas,
